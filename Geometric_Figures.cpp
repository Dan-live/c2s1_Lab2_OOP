...
Square_F* Square_F::clone()
{
	return (new Square_F(*this));
}
...
Dodecahedron* Dodecahedron::clone()
{
...
Icosahedron* Icosahedron::clone()
{
	return (new Icosahedron(*this));
	//Icosahedron(*this) = NULL;
}
