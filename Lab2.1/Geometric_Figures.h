...
public:
	...
	//int length;
	//double radius;
	//double Circumscribed_radius;//Описаний радіус 
	//int Num_of_Sides;//кількість сторін або кількість сторін у грані  
	//int Number_of_Vertices;//Кількість вершин 
	//int Num_of_Faces = NULL;//кількість граней	
	//int Num_of_Faces_adjacent_to_vertex = NULL;//кількість граней суміжних з вершиною 
	////mutable double volume = NULL;//об'єм
	//mutable double square;//Площа
